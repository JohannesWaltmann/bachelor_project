...
\begin{lstlisting}[frame=single, language={c++}, caption={Function used to generate Audio output}, label={lst:toneFunct},float= !htb]
...
Based on these conditions the function tone() as seen in Listing~\ref{lst:toneFunct} uses the method ledcWriteTone() to generate sound.
